                                    ...
                                    <div class="card p-3">
                                        ...
                                        <div class="form-group widt-100 gendetail-col">
                                            <button type="button" class="btn btn-outline-primary btn-sm download-receipt-btn" style="display:none;">
                                                <i class="fa fa-download mr-1"></i>{{ trans('lang.receipt_download_summary') }}
                                            </button>
                                        </div>
                                        <div class="form-group widt-100 gendetail-col">
    ...
    async function getOrderDetails() {
        ...
        completedorsersref.get().then(async function(completedorderSnapshots) {
            ...
            if (orderDetails.author.id != user_uuid) {
                ...
                order_subtotal_main = formatCurrency(order_subtotal_main, orderCurrency);
                ...
                /* Built from the SAME figures this screen just rendered, in
                 * the order's own currency, so the PDF and the page can never
                 * disagree about a total. */
                orderReceipt = {
                    title: "{{ trans('lang.receipt_summary_title') }}",
