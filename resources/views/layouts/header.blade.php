            ...
            <div class="row align-items-center">
                <div class="col-2">
                    <a href="{{url('/')}}" class="brand-wrap mb-0">
                        <img alt="#" class="img-fluid" src="{{asset('img/spideli_dark_logo.png')}}" id="logo_web">
                    </a>
                </div>
                <div class="col-3 d-flex align-items-center m-none head-search">
                    ...
                    {{-- Read-only: reports the region detected for this visitor. --}}
                    <span class="active-region-code" aria-live="polite"></span>
                </div>
...
<div class="d-none">
    <div class="bg-primary p-3">
        ...
        <a href="{{url('/')}}" class="mobile-logo brand-wrap mb-0">
            <img alt="#" class="img-fluid" src="{{asset('img/spideli_dark_logo.png')}}">
        </a>
